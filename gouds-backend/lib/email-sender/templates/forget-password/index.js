                        ...
                        >
                          ...
                          >
                            ...
                            href=${process.env.STORE_URL}/auth/forget-password/${option.token}
                              style="background:#7b3306;color:white;border:1px solid #7b3306; padding: 10px 15px; border-radius: 4px; text-decoration:none;"
                            >Reset Password </a>

                            <p style="margin-top: 50px;">If you did not initiate
                              this request, please contact us immediately at
                              gouds.shop@gmail.com</p>

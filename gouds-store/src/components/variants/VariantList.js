                    ...
                    el?._id === vl[att] && (
                      <button
                        ...
                        className={`${Object?.values(selectVariant).includes(vl[att])
                          ? "bg-emerald-500 text-white mr-2 border-0 rounded-lg inline-flex items-center justify-center px-3 py-1 text-lg font-serif mt-2 focus:outline-none"
                          : "bg-gray-100 mr-2 border-0 text-gray-600 rounded-lg inline-flex items-center justify-center px-3 py-1 text-lg font-serif mt-2 focus:outline-none"
                          }`}
                      >
                        {showingTranslateValue(el.name)}
                      </button>

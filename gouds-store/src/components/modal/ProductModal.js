  ...
  return (
    <>
      <MainModal modalOpen={modalOpen} setModalOpen={setModalOpen}>
        <div className="my-5 inline-block overflow-y-auto h-full align-middle transition-all transform bg-white shadow-xl rounded-2xl">
          <div className="flex flex-col lg:flex-row md:flex-row w-full max-w-4xl overflow-hidden">
            ...
            <div className="w-full flex flex-col p-5 md:p-8 text-left">
              <div className="mb-2 md:mb-2.5 block -mt-1.5">
                <h1
                  // onClick={() => setModalOpen(false)}
                  className="text-heading text-emerald-500 text-lg md:text-xl lg:text-2xl font-semibold font-serif hover:text-black cursor-pointer"
                >
              ...
              <div className="flex text-emerald-500 items-center my-4">
                <Price
                  product={product}
                  price={price}
                  currency={currency}

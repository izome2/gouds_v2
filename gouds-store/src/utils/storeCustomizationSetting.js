export const storeCustomization = {
  ...
  home: {
    ...
    quick_delivery_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our Gouds shop and get some special offers. See Our latest discounted products from here and get a special discount.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem Gouds-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
    },
    ...
    daily_need_title: {
      en: "Get Your Daily Needs From Our Gouds Store",
      de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
    },
    daily_need_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our Gouds shop and get some special offers.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem Gouds-Shop und erhalten Sie einige Sonderangebote.",
    },
  ...
  about_us: {
    ...
    founder_status: true,
    header_bg:
      "https://res-console.cloudinary.com/dj75l70ph/media_explorer_thumbnails/c559e71e4919f3b1e38c2f7cec8b58d8/detailed",
    content_right_img:
      "https://res.cloudinary.com/dj75l70ph/image/upload/v1741567049/undefined/photo-1499636136210-6f4ee915583e.jpg",
    content_middle_Img:
      "https://res.cloudinary.com/dj75l70ph/image/upload/v1741568243/undefined/close-up-chocolate-cookies.jpg",
    founder_one_img:
    ...
    top_title: {
      en: "Welcome to our Gouds shop",
      de: "Willkommen in unserem Gouds-Shop",
    },
    top_description: {
  ...
  faq: {
    ...
    faq_one: {
      en: "How does the Gouds work?",
      de: "Wie funktioniert der Gouds?",
    },
    description_one: {
    ...
    faq_five: {
      en: "What is Gouds EC2 auto scaling?",
      de: "Was ist die automatische Skalierung von Gouds EC2?",
    },
    description_five: {
      en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
    ...
    faq_six: {
      en: "What are the benefits of using Gouds affliate?",

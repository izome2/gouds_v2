  ...
  return (
    <Layout title="Search" description="This is search page">
      <div className="mx-auto max-w-screen-2xl px-3 sm:px-10">
        <div className="flex py-2 lg:py-2">
          <div className="flex w-full">
            <div className="w-full">
              ...
              {productData?.length === 0 ? (
                ...
                <div className="flex justify-between my-1 bg-gray-100 border border-gray-100 rounded p-3">
              ...
              {isLoading ? (
                ...
                <>
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 md:gap-3 lg:gap-3 mb-10">
